<template>
  <nav class="h-[70px] fixed top-0 left-0 w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-50 shadow-[0px_4px_25px_0px_#0000000D] transition-all ease-in-out">
    <nuxt-link to="/" class="text-primary-600">
